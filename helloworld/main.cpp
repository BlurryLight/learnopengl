...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    glClearColor(0.2f, 0.3f, 0.8f, 0.5f); // the color here is compressed into the range [0.0f,1.0f]
                                          // thus the standard RGB value could be expressed [100.0 / 255.0f, xxx/255.0f,xxx/255.0f]
